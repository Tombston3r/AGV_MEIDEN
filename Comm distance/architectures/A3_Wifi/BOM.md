# Nomenclature A3 : Wi-Fi + EnOcean (carte V5.0.1 conservée)

## 💰 Total

| | HT | TTC | *Accessoires écartés* |
|---|---:|---:|---:|
| **A3 : Wi-Fi + EnOcean** | **490,65 €** | **588,78 €** | *+ 101,50 € HT* |
...
### **[A2]** Carte AGV : extraite du projet KiCad
