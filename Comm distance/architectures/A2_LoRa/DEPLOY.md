...
> Document de référence : [`docs/Archi_2a_LoRa_P2P_homogene.md`](docs/Archi_2a_LoRa_P2P_homogene.md).
> La variante à boutons sans pile vit dans [`../A2_LoRa/`](../A2_LoRa/).
...
Nomenclature : `docs/Archi_2a_LoRa_P2P_homogene.md`. Schémas détaillés :
...
| Couverture radio insuffisante | Repositionner l'antenne, réduire le SF, ajouter un relais, ou basculer sur `../A3_Wifi/` |
