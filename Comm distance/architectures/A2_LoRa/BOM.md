# Nomenclature A2 : LoRa 868 MHz

## 💰 Total

| | HT | TTC | *Accessoires écartés* |
|---|---:|---:|---:|
| **A2 : LoRa, poste central compris** | **345,15 €** | **414,18 €** | *+ 72,00 € HT* |
...
|---|---:|---|
| Dongle LoRa USB | ~30,00 € + hub | L'unique port USB sert déjà si des boutons EnOcean sont installés |
