...
>
> **Périmètre** : `CarteComm/A4_Wifi/`, projet autonome et zippable. La carte AIO
...
| # | Tâche | Débloqué par |
|---|---|---|
| LG1 | ⚠️ **Remplacer `GatewayApp` (MQTT) par un `LoraGatewayApp`** — trames binaires, fenêtre d'écoute d'ACK, budget de rapport cyclique | Le transport, le pilote `Sx1276Radio` et `DutyCycleBudget` sont déjà écrits et testés |
