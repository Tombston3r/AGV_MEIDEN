...
> Documents de référence : [`docs/Archi_1_LoRa_P2P_homogene.md`](docs/Archi_1_LoRa_P2P_homogene.md)
...
| | A1 — LoRa homogène | A3 — Hybride EnOcean + LoRa |
|---|---|---|
...
exigence réelle. Si ce n'en est pas une, A1 est plus simple et rend le retour
...
- [ ] **[A1]** Ajouter l'environnement `[env:bouton]` dans `platformio.ini`
      (framework `arduino`)
...
Nomenclature : `docs/Archi_1_LoRa_P2P_homogene.md`. Schémas détaillés :
...
- [ ] **[A1]** La même clé est inscrite dans le firmware de **chaque bouton**
...
| 9 | **[A1]** Retirer la pile d'un bouton | Bouton muet ; absence détectable au poste | ☐ |
...
| Couverture radio insuffisante | Repositionner l'antenne, réduire le SF, ajouter un relais — ou basculer sur `../Wifi/` |
...
| **[A1]** Bouton muet | pile, LED rouge | Pile morte ou hors portée |
