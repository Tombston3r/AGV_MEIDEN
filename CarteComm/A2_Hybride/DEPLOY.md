...
> Document de référence : [`docs/Archi_2_Hybride_EnOcean_LoRa.md`](docs/Archi_2_Hybride_EnOcean_LoRa.md).
> La variante à boutons sur pile vit dans [`../A3_LoRa/`](../A3_LoRa/).
...
Nomenclature : `docs/Archi_2_Hybride_EnOcean_LoRa.md`. Schémas détaillés :
