...
git clone <url-du-depot> && cd CarteComm/Wifi
```
...
| Réseau d'entreprise indisponible durablement | L'AGV reste en `safe_stop` : sûr, mais inexploitable. Repli documenté : architectures `../LoRa/` ou `../SMS_EnOcean/`, sans dépendance à l'infrastructure du client |
