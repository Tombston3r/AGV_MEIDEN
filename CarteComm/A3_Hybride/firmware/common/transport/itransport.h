...
// basculer de transport sans retoucher le séquenceur. Ce dossier
// d'architecture fournit SmsTransport et MqttLteTransport ; l'implémentation
// LoRa vit dans CarteComm/LoRa/.
#pragma once
...
struct LinkHealth {
  ...
  // Émissions refusées par une contrainte propre au transport (budget de
  // rapport cyclique en ISM, quota d'abonnement en cellulaire).
  uint32_t tx_refused_duty = 0;
