...
> `RFM95W-868S2`. Ses DEUX firmwares sont réécrits. Il se construit et se teste sans
> rien emprunter aux autres dossiers de `CarteComm/`, et peut être zippé seul.
...
> reportée dans les autres dossiers de `CarteComm/`.
...
firmware/esp32/       firmware ESP32 : radio LoRa, heartbeat, maintenance
