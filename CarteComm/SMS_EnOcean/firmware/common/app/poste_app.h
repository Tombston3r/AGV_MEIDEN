// Logique du poste fixe, indépendante de la plateforme et du transport.
//
// Chaîne de cette architecture : appui PTM 210 -> TCM 515 (ESP3) ->
// déduplication -> table d'appairage -> trame CMD_GOTO -> modem cellulaire
// -> AGV. Le transport n'apparaît que derrière ITransport : la même logique
// sert telle quelle à un dossier d'architecture radio.
//
