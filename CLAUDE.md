# AGV MEIDEN — remplacement de la carte AIO AGV Control V5.0.1

> Brief complet : `CarteComm/SMS_EnOcean/CLAUDE_CODE_BRIEF_AGV_MEIDEN.md`
> Analyse cellulaire : `CarteComm/SMS_EnOcean/Archi_2_Cellulaire_SMS_LTE-M.md`
> Les références `§N` de ce dépôt renvoient au brief.
...
firmware/common/      code partagé, COMPILE EN NATIF (aucun en-tête ESP-IDF
  ...
  transport/          ITransport : LoRa, SMS, MQTT/LTE-M, budget ERC 70-03
...
firmware/poste-esp32/ poste fixe A1/A3 (EnOcean + LoRa + Ethernet)
firmware/bouton-lora/ nœud bouton sur pile (Arduino toléré ici)
...
pio run -e agv               # firmware AGV (ESP-IDF)
...
- **SMS** : ni latence bornée, ni ordre, ni garantie de remise. Le transport le
  ...
  applicative en tire les conséquences automatiquement.
