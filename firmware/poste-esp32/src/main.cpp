// Poste fixe, variante ESP32 (architectures A1 et A3) — brief §9.1.
//
// TCM 515 sur UART1 (ESP3), RFM95W sur SPI, Ethernet FILAIRE via W5500.
// L'Ethernet filaire est un choix délibéré : AUCUNE émission 2,4 GHz
// permanente. Le Wi-Fi n'est jamais démarré sur ce firmware.
...
// --- Tâche LIAISON : ordonnanceur half-duplex LoRa + diffusion WebSocket ----
void link_task(void*) {
...
extern "C" void app_main() {
  ...
  g_spi.begin(SPI2_HOST, kSpiSclk, kSpiMosi, kSpiMiso, kLoraCs, CFG_BUS_SPI_FREQ_HZ);

  static agv::esp32::Sx1276Radio radio(g_spi, g_gpio, g_clock, kLoraReset, kLoraDio0);
  ...
  static agv::PosteApp app(profile, g_clock, lora, pairings);
  g_app = &app;
